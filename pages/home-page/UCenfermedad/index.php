...
if (isset($_SESSION['rol'])) {
  if ($_SESSION['rol'] == 'Pgeneral') {
    echo '<script> function redireccionarPagina() {
        window.location = "pages/home-page/index.php";
                            }
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <button type="button" class="btn btn-outline-warning btn-sm">Cerrar Sesion <i class="fa fa-power-off" aria-hidden="true"></i></button>
            <li class="nav-item">

<?php
session_start();
/*Validacion de que este iniciada una session para poder acceder a esta pagina de la aplicacion
en caso de no contar con un inicio de sesion, la aplicacion rederijira a el
login para poder iniciar session, ademas de validar que el usuario sea el usuario
correcto que esta intentado acceder a este panel*/
if (!isset($_SESSION['rol'])) {
  echo '<script> function redireccionarPagina() {
    window.location = ".../../../../../index.php";
                        }
                 setTimeout("redireccionarPagina()", 200); </script>';
} else {
  if ($_SESSION['rol'] = !1) {
    echo '<script> function redireccionarPagina() {
      window.location = ".../../../../../index.php";
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Vida Saludable</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="<?php echo $_SESSION['rutaFotoPerfil']; ?>" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
            <a href="pages/examples/profile.php" class="d-block"><?php
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <a href="../../../modules/cerrarSesion.php" type="button" class="btn btn-outline-warning btn-sm">Cerrar Sesion <i class="fa fa-power-off" aria-hidden="true"></i></a>
          </ul>
        </nav>
        <!-- /.sidebar-menu -->
      </div>
  ...
  <!-- ./wrapper -->
  <!-- Recursos para poder desarrllar la aplicacion y que púda funcionar de manera correcta -->
  <!-- jQuery -->
